...
class ConfigArrayFactory {
    ...
    *_normalizeObjectConfigDataBody(
    ...
    _loadExtendedShareableConfig(extendName, ctx) {
        ...
        const relativeTo = ctx.pluginBasePath || path__default["default"].join(cwd, "__placeholder__.js");
        let request;
    ...
    _loadParser(nameOrPath, ctx) {
        ...
        const { cwd, resolver } = internalSlotsMap$1.get(this);
        var relativeTo = ctx.pluginBasePath || path__default["default"].join(cwd, "__placeholder__.js");
		
        if (nameOrPath.startsWith("./"))
        {
            relativeTo = ctx.filePath;
        }		
