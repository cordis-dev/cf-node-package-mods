...
class Linter {
	...
	_getFilteredRules(config, commentDirectives, options) {
		
		var list = Object.assign({}, config.rules, commentDirectives.configuredRules);
    ...
    _verifyWithoutProcessors(textOrSourceCode, providedConfig, providedOptions) {
		...
		const configuredRules = this._getFilteredRules(config, commentDirectives, providedOptions);
